...
func RunnerDividaPublica() {
	runnerName := "Divida Pública"
	url := "http://www.ipeadata.gov.br/exibeserie.aspx?serid=38388"

	domain := "www.ipeadata.gov.br"

	unidadeMedida := "% do PIB"
	file_path := "./data/inflacao/divida_publica.json"
	fileNameOutputCSV := "./data/inflacao/divida_publica.csv"
	s3KeyJSON := "inflacao/divida_publica.json"
	s3KeyCSV := "inflacao/divida_publica.csv"
