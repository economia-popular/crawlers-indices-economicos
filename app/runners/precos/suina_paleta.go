...
type SuinaPaletaKg struct {
	Atualizacao time.Time           `json:"data_atualizacao"`
	Fonte       string              `json:"fonte"`
	Data        []DataSuinaPaletakg `json:"data"`
}

func RunnerSuinaPaleta() {
	runnerName := "Preços - Carne Suina Paleta Kg"
	domain := "www.ipeadata.gov.br"
	url := "http://www.ipeadata.gov.br/ExibeSerie.aspx?serid=37606&module=M"
	file_path := "./data/precos/carne-suina-paleta.json"
	fileNameOutputCSV := "./data/precos/carne-suina-paleta.csv"
	s3KeyJSON := "precos/carne-suina-paleta.json"
	s3KeyCSV := "precos/carne-suina-paleta.csv"
